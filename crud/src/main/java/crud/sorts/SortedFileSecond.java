 ...
 */
public class SortedFileSecond<T extends Register<T>> extends SortedFile<T> {

    // Constructors

    /**
     * Constructs a new {@code SortedFileSecond} with the given file path, register size and constructor.
    ...
    /**
     * Constructs a new {@code SortedFileSecond} with the given file path, register size, comparator and constructor.
     * @param path the file path of the archive.
     * @param registerSize the size of each register in bytes.
